...
import com.carros2.api.upload.UploadInput;
...
public class FirebaseStorageService {
    ...
    private void init() throws IOException {
        if(FirebaseApp.getApps().isEmpty()) {
            InputStream in =
                    FirebaseStorageService.class.getResourceAsStream("/api-carros-balmiza-firebase-adminsdk-ez8o4-440a1a5b01.json");
            ...
            FirebaseOptions options = new FirebaseOptions.Builder()
                    ...
                    .setStorageBucket("api-carros-balmiza.appspot.com")
                    .build();
